...
(
    ...
    updated         TIMESTAMP,
    created         TIMESTAMP,
    UNIQUE (person_id, election_period, name, name_suffix) --Thus so far we cannot read changes of Fraktion within one period, as they have this same combination. But we need to check it, as some roles may appear double in the API.
);
